...
### The limit point of refactoring bears a strong resemblance to numerous mystic traditions 
### The limit point of refactoring would be a viable strategy if and only if it corresponded to reality itself 
1. A strategy can only work if it accurately reflects the true relationship between the organism and its enviroment
### Self-aware agents require a specific hierarchical structure which matches this refactoring limit 
